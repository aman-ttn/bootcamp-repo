...
public class ResourceServerConfiguration extends ResourceServerConfigurerAdapter {
    ...
    public void configure(final HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/customer/getSimilarProduct").hasAnyRole("CUSTOMER")
                .antMatchers("/customer/getProduct").hasAnyRole("CUSTOMER")
                .antMatchers("/customer/categoryDetail").hasAnyRole("CUSTOMER")
                .antMatchers("/seller/uploadImageTest").hasAnyRole("SELLER")
                ...
                .antMatchers("/admin/getCategory").hasAnyRole("ADMIN")
                .antMatchers("/admin/getAllProduct").hasAnyRole("ADMIN")
                .antMatchers("/admin/getAllCategories").hasAnyRole("ADMIN")
                ...
                .antMatchers("/admin/getMetadatafield").hasAnyRole("ADMIN")
