...
public class ActivationDao {
    ...
    public String doActivate(String token, WebRequest request){
        ...
        if (verificationToken == null) {
            ...
            throw new VerificationTokenInvalid(messageTokenInvalid);
        }
        ...
        if ((verificationToken.getExpiryDate().getTime() - cal.getTime().getTime()) <= 0) {
            ...
            throw new VerificationTokenInvalid(messageTokenExpired+"  "+verificationToken.getExpiryDate().getTime()+"   "+cal.getTime().getTime());
        }
        user.setActive(true);
